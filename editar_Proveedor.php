...
$id = $_GET['id'];
$sql = "select * from provedor where id='". $id ."'";
                                ...
                                <nav class="navbar navbar-default">
                                    ...
                                    <center>
                                        <div class="card" style="width: 50rem; margin-top: 100px;">
                                            ...
                                            <div class="card-body">
                                                <form method="POST" action="Validacion/Editar_proveedor.php?id=<?php echo $id?>">
                                                    <label>Nombre:</label><br>
                                                    <input type="text" name="txtnom" value="<?php echo $fila['nombre'] ?>" disabled="true"><br>
                                                    <label>Correo:</label><br>
                                                    <input  type="email" name="txtcorreo" value="<?php echo $fila['correo'] ?>" /><br>
                                                    <label>celular:</label><br>
                                                    <input  type="phone" name="txtcelular" value="<?php echo $fila['celular'] ?>" /><br>
